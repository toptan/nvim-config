...
nmap("-", "<Cmd>lua MiniFiles.open()<CR>", "Explore directory")
nmap_leader("ed", "<Cmd>lua MiniFiles.open()<CR>", "Directory")
nmap_leader("ef", explore_at_file, "File directory")
nmap_leader("ei", "<Cmd>edit $MYVIMRC<CR>", "init.lua")
nmap_leader("el", edit_plugin_file("50-lsp.lua"), "LSP config")
nmap_leader("ek", edit_plugin_file("20-keymaps.lua"), "Keymaps config")
nmap_leader("em", edit_plugin_file("30-mini.lua"), "MINI config")
nmap_leader("en", "<Cmd>lua MiniNotify.show_history()<CR>", "Notifications")
nmap_leader("eo", edit_plugin_file("10-options.lua"), "Options config")
nmap_leader("ep", edit_plugin_file("40-plugins.lua"), "Plugins config")
